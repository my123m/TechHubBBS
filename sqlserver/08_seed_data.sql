-- ============================================================
-- TechHub 种子数据脚本 (SQL Server 2022)
-- 文件: 08_seed_data.sql
-- ============================================================

-- ==================== user ====================
INSERT INTO [user] ([id], [username], [password], [email], [avatar_url], [bio], [role], [status], [create_time], [update_time]) VALUES (1, 'admin',    '$2a$10$sDZZncozKdyznb.ePB7qxuQGQWRjk/EFENqWsi8c82DSCRAdthDT2', 'admin@techhub.com',    NULL, '系统管理员，热爱技术，擅长全栈开发',                              'ADMIN',     1, '2026-01-01 08:00:00', '2026-01-01 08:00:00'),
...
-- ==================== category ====================
INSERT INTO [category] ([id], [name], [description], [sort_order], [status], [create_time]) VALUES (10, '技术讨论',  '讨论前沿技术、架构设计、编程语言等各类技术话题',                1, 1, '2026-01-01 08:00:00'),
...
-- ==================== post ====================
INSERT INTO [post] ([id], [title], [content], [category_id], [author_id], [type], [status], [visibility], [view_count], [like_count], [comment_count], [divine_comment_count], [eligible_for_divine], [create_time], [update_time], [deleted]) VALUES (30, 'Spring Boot 3.5 最佳实践总结',
...
-- ==================== comment ====================
INSERT INTO [comment] ([id], [content], [post_id], [user_id], [parent_id], [reply_to_user_id], [like_count], [recommend_count], [is_divine], [divine_time], [create_time]) VALUES (-- Post 30 (Spring Boot 3.5) 的回复
...
-- ==================== category_notice ====================
INSERT INTO [category_notice] ([id], [category_id], [title], [content], [type], [author_id], [is_pinned], [status], [create_time], [update_time]) VALUES (20, 10, '技术讨论版块须知',
...
-- ==================== follow ====================
INSERT INTO [follow] ([id], [follower_id], [followee_id], [create_time]) VALUES (140, 3, 1, '2026-02-01 12:00:00'), -- user 关注 admin
...
-- ==================== notification ====================
INSERT INTO [notification] ([id], [user_id], [type], [source_id], [content], [is_read], [create_time]) VALUES (170, 1, 'LIKE', 30, '用户 moderator 点赞了你的帖子《Spring Boot 3.5 最佳实践总结》', 1, '2026-02-01 12:00:00'),
